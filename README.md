...
The main intent is to show connections, trends, correlations and key contributors in digestible and visually engaging way.
...
- Generates a weekly prose digest, semantic similarity chart and other insights every week
